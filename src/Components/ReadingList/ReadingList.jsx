...
export function ReadingList ({ lectureBooks, handleRemoveImageFromLecture }) {
  ...
  return (
    ...
    {lectureBooks && listOpen
      ? <section ref={myRef}
      className='overflow-y-scroll opacity animate-fade-left  animate-duration-[400ms] transition-all px-4
      duration-300 w-[50%] md:w-[36%] h-full bg-gray-800 rounded  min-h-screen fixed right-0 top-0 z-30 pb-4 sm:pb-16
      '>
